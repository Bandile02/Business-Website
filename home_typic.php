...
<html>
	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				<li class="fa icon-diamond" ><a href="home.php">
			...
			<section id="one" class="wrapper style1 special">
				<div class="inner">
					<article class="feature right">
						<span class="image" ><img src="images/Subscribed1.png" alt="" />
						</span>
						<div class="content">
						<h2>Alprize Typic</h2>
						<p><b>You are currently subscribed to Alprize Typic Account<br></b>
