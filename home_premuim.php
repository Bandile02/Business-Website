...
<html>
	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				<li class="fa icon-diamond" ><a href="home_2.php">
		...
		<section id="three" class="wrapper style3 special">
			...
			<section id="one" class="wrapper style1 special">
				<div class="inner">
					<article class="feature right">
						<span class="image" ><img src="images/Subscribed3.png" alt="" />
						</span>
						<div class="content">
						   <h2>Alprize Premuim</h2>
						<p><b>You are currently subscribed to Alprize Premuim Account<br></b>
			...
			<section id="one" class="wrapper style1 special">
				<div class="inner">
					...
					<article class="feature left">
						<span class="blur"><img src="images/Subscribe2.png" alt="" /></span>
						<div class="content">
							<div class='blur'>
							<p>ALPRIZE PRO</p>
							 <p>Aprize Pro offers a wide range of store that are well-known.<br>
							<i>Are you Tired of going for one store to another just to look for price?</i><br>
							<i>Are you tired of entering a store and not knowing if you have enough cash?</i>
							<p>Don't Worry We Are Here For You</p><br>
							<p>Alprize Pro Benefits:</p>
							<li>View Prices In Your Social Media</li>
						...
						<br>
							<ul class="actions">
								<li>
									<a href="pro2.php" class="button alt" name="paynow">UPGRADE R 49,97</a>
								</li>
							</ul>
						</div>
					</article>
